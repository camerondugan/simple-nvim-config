...
require('lazy').setup {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sd', extensions.zoxide.list, { desc = 'Search directories/folders' })
  ...
  { -- You can easily change to a different colorscheme(color theme).
